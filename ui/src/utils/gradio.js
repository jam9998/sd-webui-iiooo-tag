...
let el_selector = {
  ...
  el_txt2img_prompt_textarea:
    "div[id=txt2img_prompt] textarea[data-testid=textbox]",
  el_txt2img_neg_prompt_textarea:
    "div[id=txt2img_neg_prompt] textarea[data-testid=textbox]",
  el_img2img_prompt: "div[id=img2img_prompt_container] div",
  el_img2img_prompt_textarea:
    "div[id=img2img_prompt] textarea[data-testid=textbox]",
  el_img2img_neg_prompt_textarea:
    "div[id=img2img_neg_prompt] textarea[data-testid=textbox]",
};
